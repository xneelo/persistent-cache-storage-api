...
[![Gem Version](https://badge.fury.io/rb/persistent-cache-storage-api.svg)](https://badge.fury.io/rb/persistent-cache-storage-api)
[![Build Status](https://github.com/xneelo/persistent-cache-storage-api/actions/workflows/test.yml/badge.svg)](https://github.com/xneelo/persistent-cache-storage-api/actions/workflows/test.yml)
[![Coverage Status](https://coveralls.io/repos/github/xneelo/persistent-cache-storage-api/badge.svg?branch=master)](https://coveralls.io/github/xneelo/persistent-cache-storage-api?branch=master)
